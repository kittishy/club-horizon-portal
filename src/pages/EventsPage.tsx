...
import { CalendarDays, Clock, MapPin, Users, AlertTriangle, ExternalLink } from 'lucide-react';
...
const EventsPage: React.FC = () => {
  ...
  const { events, totalCount, totalPages, isLoading, isError, error } = useEventsData(currentPage, ITEMS_PER_PAGE);
  ...
  if (isLoading && !events) { // Mostrar loader apenas no carregamento inicial
    return <PageLoader />;
  }
